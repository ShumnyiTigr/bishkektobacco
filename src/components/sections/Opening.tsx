    ...
    >
      <div className="container-edge text-center max-w-2xl">
        ...
        <div className="pt-10 border-t border-hairline">
          ...
          <div className="mt-8 flex items-center justify-center gap-4 text-[11px] tracking-[0.22em] uppercase">
            <a
              href="https://wa.me/996559777799"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-gold/50 text-gold hover:bg-gold hover:text-background transition-colors"
            >
